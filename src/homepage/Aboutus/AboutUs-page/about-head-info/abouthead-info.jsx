...
import cardfree from "./cardfree.png";
                    ...
                    <div className="about-head-info">
                        ...
                        <div className="row" style={{marginTop:"20px"}}>
                            <div className="col-lg-4">
                                ...
                                <h4 style={{textAlign:"center", marginTop:"20px"}}><img src={card} alt="image"/>PayThru Credit</h4>
                            ...
                            <div className="col-lg-4">
                                ...
                                <h4 style={{textAlign:"center", marginTop:"20px"}}><img src={debit} alt="image"/>PayThru Debit</h4>
                            ...
                            <div className="col-lg-4">
                                ...
                                <h4 style={{textAlign:"center", marginTop:"20px"}}> <img src={search} alt="image"/>BVN Validation</h4>
                        ...
                        <div className="col-lg-4">
                                ...
                                <h4 style={{textAlign:"center", marginTop:"20px"}}><img src={cardfree} alt="image"/>PayThru CardFree</h4>
                            ...
                            <div className="col-lg-4">
                                ...
                                <h4 style={{textAlign:"center", marginTop:"20px"}}><img src={card} alt="image"/>PayThru NQR</h4>
                            ...
                            <div className="col-lg-4">
                                ...
                                <h4 style={{textAlign:"center", marginTop:"20px"}}><img src={single} alt="image"/>Single View</h4>
