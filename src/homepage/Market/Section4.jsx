...
export default function Section4() {
  return <div className="packed">
    ...
    <div className="joined">
        <img src={arrowside} className='arrowside' alt="arrowside" />
    ...
    <div className="joined">
        ...
        <p style={{paddingBottom:"40px"}}>Counterparty to create a Tazapay account and accept escrow payment request</p>
    </div> 
    <div className="joined">
        <img src={arrowside} className='arrowside' alt="arrowside" />
        <h5 className="sendesc">Transfer Payment to Tazapay</h5>
        <p style={{paddingBottom:"40px"}}>Buyer to transfer the invoice amount, Tazapay will safeguard the funds until the order is fulfilled</p>
    </div>
    </div>
    <div style={{display:"flex", justifyContent:"center", flexWrap:"wrap"}}> 
